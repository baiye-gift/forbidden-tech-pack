...
$suiteCatalog = [ordered]@{
    ...
    'ReconstructorAssetSourceContractTests' = [pscustomobject]@{
        Path = (Join-Path $projectRoot 'tests\ReconstructorAssetSourceContractTests.ps1')
        RequiresGame = $false
    }
    'EntropyDiverterAssetSourceContractTests' = [pscustomobject]@{
        Path = (Join-Path $projectRoot 'tests\EntropyDiverterAssetSourceContractTests.ps1')
        RequiresGame = $false
    }
    'AnnihilationReactorAssetSourceContractTests' = [pscustomobject]@{
        Path = (Join-Path $projectRoot 'tests\AnnihilationReactorAssetSourceContractTests.ps1')
        RequiresGame = $false
    }
    ...
    'AnnihilationReactorSourceContractTests' = [pscustomobject]@{
        Path = (Join-Path $projectRoot 'tests\AnnihilationReactorSourceContractTests.ps1')
        RequiresGame = $false
    }
    'AnnihilationReactorIntegrationSourceContractTests' = [pscustomobject]@{
        Path = (Join-Path $projectRoot 'tests\AnnihilationReactorIntegrationSourceContractTests.ps1')
        RequiresGame = $false
    }
